...
public sealed partial class RDCharacterEditorCharacteristicsControl : BoxContainer
{
    private readonly ProtoId<RDCharacteristicGroupPrototype> _group = "Main";

    [Dependency] private readonly IPrototypeManager _prototype = default!;

    public RDCharacterEditorCharacteristicsControl()
    {
        RobustXamlLoader.Load(this);
        IoCManager.InjectDependencies(this);

        foreach (var prototype in _prototype.EnumeratePrototypes<RDCharacteristicPrototype>())
        {
